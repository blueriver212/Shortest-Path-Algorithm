...
def gorunning():
    ...
    address = 'Blackwater Residentual Home, Blackwater, Newport, PO30 3BJ'
    pt_finder = GoogleMaps(address)
    pt = pt_finder.get_shapely_point()
    ...
    plot_bg = MapPlotting(bg_path, dijkstra, pt, highest_point_in_area, nearest_node, highest_node,
                          clipped_path).plot_map()
